...
public static Target menu =Target.the("").locatedBy("");
...
public static Target Administracion 					= Target.the("El menú ").locatedBy("");
public static Target Administracion_Basico				= Target.the("El menú ").locatedBy("");
public static Target Administracion_Basico_Etiquetas	= Target.the("El menú ").locatedBy("");
